...
async def get_product_taxonomy(
    ...
    # Query única: Product.category devuelve directamente un TaxonomyCategory
    # (ProductTaxonomyNode y taxonomyCategory(id:) fueron deprecados por Shopify).
    # TaxonomyCategoryAttribute es una UNION: fragmentos inline por tipo.
    # Verificado por introspección real contra 2026-04 (2026-08-08):
